const baseUrl = "http://localhost:3000" // Replace the value "http://example.com" by the base URL of the website you want to test.
const referenceUrl = "https://pulse-calc-seven.now.sh"
const projectId = "Pulse Cashflow Calculator" // Replace the value "sample project" by the id of your project. It can be any string (e.g., "my-website").
